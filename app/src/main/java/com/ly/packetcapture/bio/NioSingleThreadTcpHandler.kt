...
import com.ly.packetcapture.protocol.tcpip.TCBStatus
import kotlin.Throws
import com.ly.packetcapture.protocol.tcpip.IpUtil
import com.ly.packetcapture.protocol.tcpip.TCPHeader
 ...
 */(//用于读包
    ...
    private fun initPipe(packet: Packet): TcpPipe {
        ...
        Log.i(
            ...
            String.format(
                "initPipe %s %s",
                pipe.destinationAddress.toString().replace(".", ","),
                b1
            )
        )
        return pipe
...
//            if (Config.logAck) {
    ...
    fun isClosedTunnel(tunnel: TcpPipe?): Boolean {
